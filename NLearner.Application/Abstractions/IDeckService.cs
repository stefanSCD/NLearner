...
namespace NLearner.Infrastructure.Service
{
    public interface IDeckService
    {
        ...
        Task<Card?> GetCardAsync(Guid cardId, string userId);
        Task UpdateCardReviewAsync(Guid cardId, ReviewQuality quality, string userId);
        ...
        Task<List<Card>> GetDueCardsAsync(Guid deckId, string userId);
        Task<Deck?> GetDeckAsync(Guid deckId, string userId);
    }
}
